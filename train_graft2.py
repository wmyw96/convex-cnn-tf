...
parser.add_argument('--pnanase', default=1, type=int)
...
for i in range(args.nanase - args.pnanase):
    params['grafting']['layer_mask'][i + args.pnanase - 1] = False

print(params['grafting']['layer_mask'])
...
if len(args.model1dir) > 5:
    ...
    assign_weights(targets['grafting']['assign_net1'], 1, args.pnanase - 1)
...
#if not os.path.exists(args.statlogdir):
#    os.makedirs(args.statlogdir)
